...
import net.coreprotect.database.statement.AbilityBlockStatement;
...
public class AbilityBlockPlaceLogger {

    private AbilityBlockPlaceLogger() {
        throw new IllegalStateException("Database class");
    }

    public static void log(PreparedStatement preparedStmt, int batchCount, String user, BlockState block, int replacedType, int replacedData, Material forceType, int forceData, boolean force, List<Object> meta, String blockData, String replaceBlockData, String player, String ability) {
        try {
            ...
            AbilityBlockStatement.insert(preparedStmt, batchCount, time, userId, wid, x, y, z, internalType, data, meta, blockData, 1, 0, player, ability);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
